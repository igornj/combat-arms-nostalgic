      ...
      <HistoriaContent>
        <BlackContent>
          ...
          <p>
            ...
            divertido pra cacete, o famigerado <b>"CA"</b> ou <b>Combat Arms</b>{' '}
            para os menos chegados. <br />
            ...
            <b>Cross Fire</b> ou <b>Point Blank</b> por exemplo e sinceramente,
            eu não faço a menor ideia de como o jogo conseguiu competir bem com
            esses outros FPS que eram também de graça. Inclusive alcançando uma
            galera de outros FPS pagos ou com uma comunidade bem mais
            consolidada como a do <b>Counter-Strike</b>.
          </p>
        ...
        <WhiteContent>
          ...
          <p>
            ...
            maluco mas se divertindo pra cacete. Eu jogava tanto sozinho quanto
            com o Alan as vezes, mas ele diferentemente de mim não tava tão
            viciado, então ele dava atenção pra outros jogos também.
            <br />
            ...
            lendário <b>"JuPanteraBR"</b> jogador(a) com a maior patente do jogo
            até então estava dentro do mesmo lobby que eu.
          </p>
          <ImgContainer>
        ...
        <BlackContent>
          ...
          <p>
            ...
            ele na conversa, Inclusive virou quase que um padrão eu falar com o
            Alan sobre quando a gente se encontrava na rua.
            <br />
            <br />
            Até esse momento, eu ainda jogava mais sozinho ou com pessoas que eu
            adicionava dentro do jogo mesmo.
            <br />
            <br />
            Isso mudaria quando ainda em 2011, um outro amigo de infância
            chamado <b>Guilherme "gzk" Anacleto</b> comentasse que também estava
            jogando o Combat Arms em uma conversa aleátoria comigo e com o Alan.
            <br />
            <br />
            ...
            não tinha um dia que não nos encontravamos pra jogar ou pra ficar
            enfiado na casa do outro jogando.
            <br />
            <br />O jogo fez esses 3 nerdolas ficarem mais juntos do que nunca,
            compartilhando os acontecimentos da vida e descobrindo outros jogos
            novos também conforme o tempo passava.
          </p>
        ...
        <WhiteContent>
          ...
          <p>
            Não demorou muito pra tanto eu quanto o Guilherme começarmos a ficar
            bom no jogo. Obviamente um jogador considerado bom pra mim pode ser
            diferente de bom pra você mas{' '}
            ...
            muito grande. Assim, na busca de novos desafios fora dos servidores
            ...
            <b>Tentar balanciar o confronto entre times,</b> criando regras onde
            somente algumas armas eram permitidas, deixando o jogo bem mais
            competitivo e menos irritante eu diria, porque o Combat Arms era bem
            conhecido pelo seu{' '}
            ...
            <b>formato exato utilizado pelas ligas que faziam os campeonatos</b>
            ...
            primeira vez que eu tava tendo uma visão do competitivo de um jogo.
            <br />
            <br />
            Não preciso nem dizer que a gente <b>VIVIA</b> nesses servidores, a
            gente parou completamente de jogar qualquer um dos outros modos do
            jogo que não fosse esse. Alias não só a gente como os outros
            servidores diminuiram consideravelmente a quantidade de players
            casuais,{' '}
            <b>
              todo mundo queria descobrir porque tinham tantas salas com senhas
              e lotadas.
            </b>{' '}
            <br />
            <br />A e não posso esquecer que a gente metia uma mala, entrando
            nas salas dentro do <b>TeamSpeak das ligas ficando mutado</b>. Isso
            aqui era só pra mostrar que tu tava la jogando e era ativo na
        ...
        <BlackContent>
          ...
          <p>
            Nessa mesma época, o Guilherme teve a ideia meio doidera mas também
            genial de <b>mudar nossos nicks.</b> O engraçado é que o maldito nem
            me avisou, um dia eu loguei na minha conta todo inocente e já estava
            trocado porque ele tinha acesso.
            <br />
            <br />
            Os nicks novos eram <b>"-BlacK___S2"</b> e <b>"-FunK___S2"</b>, toda
            vez que eu lembro disso eu começo a rir igual um besta não tem como.
            Basicamente a ideia dele foi colocar dois estilos músicais que a
            gente escutava na época nos nomes. Na época eu fiquei <b>PUTO</b>{' '}
            porque não tinha curtido tanto, mas conforme os dias iam passando eu
            começava a gostar mais do nick, principalmente porque nos lobbys da{' '}
            <b>WGB</b> e <b>LB7 </b>a gente sempre jogava junto e destruia,
            acabou criando uma fama nessa duplinha.
            <br />
            <br />
            ...
            nick depois disso só uma vez, que foi pra <b>"bllk-"</b> que é Black
            só que encurtado e mantive isso em todos os outros jogos que joguei,
            inclusive quando migramos para outros jogos. O engraçado é que o
            Guilherme trocou de nick diversas vezes, como eu mantive o meu as
            pessoas achavam que meu nick era uma referencia a cor <b>"Preta"</b>{' '}
            quando na verdade era um estilo músical pra fazer duplinha com o{' '}
            <b>Funk do "-FunK___S2".</b>
          </p>
        ...
        <WhiteContent>
          ...
          <p>
            ...
            <br />
            <br />
            Por volta do final do ano de 2011, a gente tava na busca de criar um
            time pra começar a disputar os campeonatos, um deles foi a
            ...
            <br />
            <br />
            Infelizmente o Combat Arms tinha a maldita fama de ser infestado por{' '}
            <b>Hackers</b>, o que era bem verdade, mesmo os campeonatos tendo
            alguns <b>anti-cheats</b> melhores que o da <b>Level UP</b>, não
            tinha como segurar essa porrada de hacks novos saindo todos os dias.
            A frase <b>"TEM TV?"</b> era bem comum na época por conta disso,
            como as salas LB7 e WGB não podiam ter um anti-cheat melhor rodando
            do que o que vinha com jogo, utilizavamos o <b>Team Viewer</b>,{' '}
            programa que ajudava a gente investigar o PC da pessoa afim de{' '}
            ...
            cara tava limpo ou não, só o tempo mesmo dizia. Nessas tentativas a
            gente teve alguns problemas com varios{' '}
            <b>
              carinhas que entraram para o clan e usavam hack na nossa cara sem
              dó.
            </b>
            <br />
            <br />
            Por essas e outras que a gente parou com a ideia de criar um clan e
            ficou somente esperando a oportunidade cair do céu.
          </p>
        ...
        <BlackContent>
          ...
          <p>
            ...
            destino as{' '}
            <b>amizades que eu levaria para vida, tiradas de dentro do jogo.</b>
            <br />
            <br />O mapa era <b>Sand Hog</b> em um lobby da WGB, eu estava
            jogando sozinho nesse dia e não me lembro se eu tava jogando bem ou
            não mas provavelmente meu{' '}
            ...
            time não tão conhecido na comunidade mas já estavam a bastante tempo
            disputando as ligas e outros confrontos entre clans. Quando ele me
            chamou eu ja fui direto pesquisar sobre eles porque tanto eu e o
            Guilherme tinhamos recebidos alguns outros convites mas{' '}
            <b>
            ...
            <b>eles poderiam kickar a gente em seguida.</b> Felizmente, deu tudo
            certo e a gente <b>DESTRUIU </b>nos primeiros <b>"CF"</b> ou Clan
            Fights com eles.
            <br />
            <br />
        ...
        <WhiteContent>
          ...
          <p>
            ...
            ainda mais times da comunidade e algumas tretas ou entre players ou
            até times inteiros rolavam,{' '}
            <b>
              o que era completamente normal você xingar até a ultima geração da
              familia do inimigo por ter te matado.
            </b>
            <br />
            <br />
            Tanto que em uma dessas partidas jogamos contra o <b>UpperClutch</b>
            , clan que ja tinha alguma treta com o <b>ScreeN</b> por conta de
            membros trocados e outras coisas que eu não tinha conhecimento
            sobre, porque era uma historia que aconteceu muito antes de eu
            entrar para o time. Na partida estavamos utilizando o TeamSpeak da
            LB7, eles disponibilizavam umas salas vazias para os times que não
            tinham um server próprio ou outra forma pra se comunicar durante o
            jogo.{' '}
            <b>
              E pela força do destino, o time UpperClutch estava numa sala logo
              abaixo, dentro do mesmo servidor.
            </b>
            <br />
            <br />
            ...
            <br />
            <b>
              Resumindo, todo mundo saiu do TS depois e foi isso, a gente só se
              xingou e vazou, doideira.
            </b>
            <br />
            <br />O mais engraçado de tudo isso é que após esse ocorrido é que{' '}
            <b>a gente começou a jogar contra quase que todos os dias</b>, como
            a gente ja se "conhecia" de alguma forma e o nivel dos dois times
            eram parecidos, as partidas eram bem disputadas e tinha dias que a
            gente jogava varias e varias vezes contra afim de mostrar quem era o
            melhor. Não demorou muito pra criarmos amizade com eles e membros
            jogarem com outros contas pra completar lines pra um e para o outro.
            <br />
            <br />
            Eu participando de tudo isso e começando a criar uma amizade também
            com os caras do UpperClutch,{' '}
            <b>
        ...
        <BlackContent>
          ...
          <p>
            Após essa fusão, a quantidade de partidas que conseguiamos jogar era
            absurda. Pela quantidade grande nova de membros, muitas vezes tinham
            3 a 4 times pra jogar e uma galera ainda esperando na fila de
            próximo, com certeza essa época foi o momento mais ativo de todo o
            clan.
            <br />
            <br />
            <b>
            ...
            <i>
              <b>
                ...
                nesse época o jogo tava em chamas e tanto eu quanto o Guilherme
                gostavamos de passar umas horas la mesmo ainda dando atenção
                para o CA.
              </b>
            </i>
            <br />
            ...
            semana, o que fazia a gente ter que criar a line mais forte possivel
            pra jogar contra. Um dos problemas que tinhamos eram membros que
            tinham que estar na line mas começaram a ter alguns compromissos nos
            dias de campeonatos, o outro problema era membros da line vinda do
            ScreeN que mesmo depois de discutido que não estariam na line
            principal, seja por skill ou qualquer outra coisa{' '}
            ...
            enquanto{' '}
            <b>
              todos do UpperClutch eram de São paulo e assustadoramente estavam
              MUITO perto da onde eu e o Guilherme moramos até hoje
            </b>
            . Esse detalhe fez com que a gente se aproximasse bastante da galera
            do UpperClutch, tanto pelos encontros que rolaram mas principalmente
            por concordarmos das mesmas coisas que estavam rolando no momento.
            <br />
            <br />
            Mais ou menos na metade do ano de 2012,{' '}
            <b>uma treta maior aconteceu e o clan se dividiu agora pra valer</b>
            ...
            agora com menos da metade dos membros que tinhamos quando juntos com
            o ScreeN, porém com{' '}
            <b>
              praticamente todos os membros ativos e com uma line principal mais
              fechada e até com substitutos muito bons.
            </b>
            <br />
            <br />
        ...
        <WhiteContent>
          ...
          <p>
            ...
            sinergia muito boa e além disso tendo já criado conexões até fora do
            jogo, o UpperClutch estava pronto para o sucesso. Acredito que todos
            os membros que participaram dessa historia concordam comigo,{' '}
            ...
            Fight e batendo de frente muitas vezes com times grandes do cenário,{' '}
            <b>
        ...
        <BlackContent>
          ...
          <p>
            O time jogou junto o Combat Arms de 2012 até mais ou menos metade do
            ano de 2015 onde migramos do CA para o Counter-Strike: Global
            Offensive que jogamos e acompanhamos até hoje.
            <br />
            <br />
            Mas o mais legal de toda essa historia são as amizades que encontrei
            dentro do jogo. E é doideira pensar que caso algumas coisas não
            acontecessem, hoje eu não conheceria nenhum desses malucos que amo.
            <br />
            <br />
            É por essas e outras que o Combat Arms tem um espaço reservado no
            meu coração, mesmo não jogando mais o jogo eu sei da importancia que
            ele teve na minha vida.
            <br />
            <br />
            E como todos aquelas madrugadas a dentro jogando, sofrendo ameaça de
            morte da minha mãe, valeram a pena.
            <br />
            <br />
            <i>
